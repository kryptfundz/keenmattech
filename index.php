...
<head>
    ...
    <link rel="shortcut icon" href="assets/2.png" type="image/png">
</head>
<body>
    <!-- Navigation Bar -->
    <nav class="navbar">
            ...
            <div class="card">
                <div class="card-inner">
                    <div class="card-front">
                        <img src="assets/profile.png" alt="Profile" class="card-img">
  ...
  method="POST">
            ...
            <div class="profile-pics">
                <div class="profile-pics-holder">
                    <img src="assets/profile.png" alt="" srcset="" width="80%">
                </div>
            </div>
        </div>
    </section>
